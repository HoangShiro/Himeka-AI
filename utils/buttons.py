...
async def status_warehouse(interaction):
    ...
    embed.add_field(name="🟩 21", value="🟩 22", inline=True)
    embed.add_field(name="🟩 23", value="🟩 24", inline=True)
    embed.add_field(name="🟩 25", value="🟩 26", inline=True)
    embed.add_field(name="🟩 27", value="🟩 28", inline=True)
    embed.add_field(name="🟩 29", value="🟩 30", inline=True)
    embed.add_field(name="🟩 31", value="🟩 32", inline=True)
    embed.add_field(name="🟩 33", value="🟩 34", inline=True)
    embed.add_field(name="🟩 35", value="🟩 36", inline=True)
    embed.add_field(name="🟩 37", value="🟩 38", inline=True)
    embed.add_field(name="🟩 39", value="🟩 40", inline=True)
    embed.add_field(name=f"\u200b", value="", inline=False)
