...
async def item_add(interaction: discord.Interaction,
        ...
        choices=[
            ...
            discord.OptionChoice(name="32", value=32),
            discord.OptionChoice(name="64", value=64),
            discord.OptionChoice(name="128", value=128),
            discord.OptionChoice(name="512", value=512),
        ],
    ) = 0,
                    sell: int=0,
                    lv: discord.Option(
        ...
        choices=[
            ...
            discord.OptionChoice(name="s", value=6),
        ],
    ) = 1,
                    cp: int=0,
                    spd: int=0,
